...
func (ec *executionContext) _Author_books(ctx context.Context, field graphql.CollectedField, obj *model.Author) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNBook2ᚕᚖgithubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐBookᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createBook(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Book)
	fc.Result = res
	return ec.marshalNBook2ᚖgithubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐBook(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createAuthor(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAuthor2ᚖgithubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐAuthor(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAuthor2githubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐAuthor(ctx context.Context, sel ast.SelectionSet, v model.Author) graphql.Marshaler {
	return ec._Author(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthor2ᚖgithubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐAuthor(ctx context.Context, sel ast.SelectionSet, v *model.Author) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNBook2githubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v model.Book) graphql.Marshaler {
	return ec._Book(ctx, sel, &v)
}

func (ec *executionContext) marshalNBook2ᚕᚖgithubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐBookᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Book) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNBook2ᚖgithubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐBook(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNBook2ᚖgithubᚗcomᚋryohei1216ᚋgqlgenᚑresolverᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v *model.Book) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
